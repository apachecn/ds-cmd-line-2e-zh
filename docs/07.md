...
*   写出了《社榜》(`#!`)；参见从命令行运行`R`脚本所需的[第四章](chapter-4-creating-command-line-tools.html#chapter-4-creating-command-line-tools)。

...
> 原文:[https://datascienceathecommandline . com/2e/chapter-6-project-management-with-make . html](https://datascienceatthecommandline.com/2e/chapter-6-project-management-with-make.html)
...
In the first edition, this chapter used `drake` instead of `make`. Drake was supposed to be a successor to `make` with additional features to work with data. Unfortunately, Drake was abandoned by its creators in 2016 with too many unresolved bugs. That’s why I’ve decided to use `make` instead.
...
![Distribution of heights per species in Star Wars](../Images/6b477766001a94f5ab0ae30411f787a2.png)
...
![Dependencies between targets](../Images/b81cc4bee210ed901cd2de006c0f931d.png)
